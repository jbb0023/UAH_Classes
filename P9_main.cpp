...
// ***********************************************************************
// ***********************************************************************
// Project 9 - Directory ReOrganizer   
...
#include <string>
#include <iomanip>
#include "P9.h"   // prototypes, constants and structure declarations for project 9
...
int main()
{
	...
	if (!inFile)
	{
        cout << string(17,'*') << " Directory Title Error " << string(17,'*') << endl;
